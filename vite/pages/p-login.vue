...
<template>
  <div class="box-border flex flex-col h-full m-x-auto lg:max-w-200 sm:max-w-148 xl:max-w-250 p-6 sm:p-x-0 sm:p-y-6 w-full">
    ...
    <div class="flex flex-1 flex-col gap-6 items-center justify-center w-full">
      <a class="decoration-none text-inherit" v-bind:href="loginUrl">
        <PVButton
          label="Login with Netlify"
          v-bind:pt="{
            root: 'bg-transparent dark:hover:bg-neutral-000 hover:bg-neutral-light-800 border-1 border-neutral-light-800 border-rounded-1.5 border-solid dark:border-neutral-000 cursor-pointer flex font-600 font-mulish gap-x-4 group items-center p-x-10 p-y-3 text-4.5 text-inherit dark:hover:text-neutral-light-800 hover:text-neutral-000 transition-duration-250 w-90'
          }">
