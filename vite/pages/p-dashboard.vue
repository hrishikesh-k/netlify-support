...
<template>
  <PVCard v-bind:pt="{
    root: 'dark:bg-neutral-dark-800 border-1 border-rounded-2 border-solid dark:border-neutral-dark-700 box-border p-6'
  }">
    <template v-slot:content>
      <PVDataTable v-bind:value="ticketList.tickets">
        <PVColumn field="id" header="Ticket ID"></PVColumn>
        <PVColumn field="subject" header="Subject"></PVColumn>
